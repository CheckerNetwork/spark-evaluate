...
export const buildRetrievalStats = (measurements, telemetryPoint) => {
  ...
  let networkRetrievalSuccesses = 0
  ...
  for (const m of measurements) {
    ...
    if (m.alternativeProviderRetrievalResult === 'OK') { networkRetrievalSuccesses++ }
  ...
  const networkRSR = totalForRSR ? networkRetrievalSuccesses / totalForRSR : 0
